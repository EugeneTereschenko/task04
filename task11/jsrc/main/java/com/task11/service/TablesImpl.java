...
public class TablesImpl {
    ...
    public APIGatewayProxyResponseEvent getTables() {
        ...
        return new APIGatewayProxyResponseEvent()
                ...
                .withStatusCode(200).withBody(json);
    }
    ...
    public APIGatewayProxyResponseEvent saveTable(String requestBody) throws IOException {
        ...
        try {
            ...
            return new APIGatewayProxyResponseEvent()
                    ...
                    .withHeaders(Collections.singletonMap("Access-Control-Allow-Methods", "*"))
                    .withHeaders(Collections.singletonMap("Accept-Version", "*"))
                    .withStatusCode(200).withBody("{\"id\":" + table.getId() + "}");
        } catch (Exception e) {
            ...
            return new APIGatewayProxyResponseEvent()
                    ...
                    .withHeaders(Collections.singletonMap("Access-Control-Allow-Methods", "*"))
                    .withHeaders(Collections.singletonMap("Accept-Version", "*"))
                    .withStatusCode(200).withBody("{\"id\":\"" +  new TableDTO(0, 0, 0, false, 0) + "\"}");
        }
    }
    ...
    public APIGatewayProxyResponseEvent getTablesById(int id) {
        ...
        try {
            ...
            return new APIGatewayProxyResponseEvent()
                    ...
                    .withHeaders(Collections.singletonMap("Access-Control-Allow-Methods", "*"))
                    .withHeaders(Collections.singletonMap("Accept-Version", "*"))
                    .withStatusCode(200).withBody(gson.toJson(response));
        } catch (Exception e) {
            return new APIGatewayProxyResponseEvent()
                    .withHeaders(Collections.singletonMap("Access-Control-Allow-Headers", "Content-Type,X-Amz-Date,Authorization,X-Api-Key,X-Amz-Security-Token"))
                    .withHeaders(Collections.singletonMap("Access-Control-Allow-Origin", "*"))
