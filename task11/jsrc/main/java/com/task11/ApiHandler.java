...
import com.task11.service.ReservationImpl;
import com.task11.service.SignInImpl;
import com.task11.service.SignUpImpl;
import com.task11.service.TablesImpl;
        ...
        if (path.equals("/signup") && httpMethod.equals("POST")) {
            ...
            try {
                ...
                return new APIGatewayProxyResponseEvent()
                        ...
                        .withStatusCode(400).withBody(e.toString());
            }
            ...
            return new APIGatewayProxyResponseEvent()
                    ...
                    .withHeaders(Collections.singletonMap("Access-Control-Allow-Methods", "*"))
                    .withHeaders(Collections.singletonMap("Accept-Version", "*"))
                    .withStatusCode(404).withBody("Error request");
        }
    }
}
